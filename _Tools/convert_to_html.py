...
# Read markdown file
with open(r'c:\Stash\SideKick_PS\_Docs\dev\ProSelect_GHL_Field_Mapping.md', 'r', encoding='utf-8') as f:
    md_content = f.read()
...
# Write HTML file
output_path = r'c:\Stash\SideKick_PS\_Docs\dev\ProSelect_GHL_Field_Mapping.html'
